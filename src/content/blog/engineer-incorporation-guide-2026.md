...
description: 'フリーランスエンジニアが法人化（法人成り）すべきタイミングを年間所得800万円・1000万円の基準で判断。合同会社と株式会社の設立手続きと費用の違い、個人事業主との税務面の比較、社会保険料シミュレーションを2026年最新情報で徹底解説します。'
pubDate: '2026-03-05'
tags: ['フリーランス', '確定申告', '税金', 'キャリア']
heroImage: '../../assets/thumbnails/engineer-incorporation-guide-2026.jpg'
---
## はじめに
...
```
【法定費用】
登録免許税:        ¥60,000（最低額、資本金の0.7%）
定款認証:          ¥0（合同会社は不要）
定款の収入印紙:     ¥0（電子定款の場合）
                   ¥40,000（紙定款の場合）

【実費】
会社印鑑セット:     ¥3,000〜15,000（ネット注文が安い）
印鑑証明書:        ¥300 × 必要枚数
登記事項証明書:     ¥600 × 必要枚数

【合計】
最安パターン（電子定款）:  約¥65,000
紙定款の場合:             約¥105,000
司法書士に依頼する場合:    約¥120,000〜150,000
```
...
```
【法定費用】
登録免許税:        ¥150,000（最低額、資本金の0.7%）
定款認証:          ¥30,000〜50,000（資本金額により変動）
定款の収入印紙:     ¥0（電子定款の場合）
                   ¥40,000（紙定款の場合）

【実費】
会社印鑑セット:     ¥3,000〜15,000
印鑑証明書:        ¥300 × 必要枚数
登記事項証明書:     ¥600 × 必要枚数

【合計】
最安パターン（電子定款）:  約¥185,000
紙定款の場合:             約¥245,000
司法書士に依頼する場合:    約¥250,000〜300,000
```
...
| 決算公告費 | 不要 | ¥30,000〜/年（官報の場合） |
| 役員変更登記 | 任期なし（不要） | ¥10,000/回（任期ごと） |
...
Week 1:
  □ 会社名を決定（類似商号チェック）
  □ 事業目的を決定
  □ 本店所在地を決定（自宅 or バーチャルオフィス）
  □ 資本金額を決定（1円〜OK、100万円が目安）
  □ 決算月を決定（設立月から最も離れた月が有利）
  □ 会社印鑑の発注

Week 2:
  □ freee会社設立 or マネーフォワード会社設立で書類作成
  □ 定款の作成（電子定款がおすすめ）
  □ 株式会社の場合: 公証役場で定款認証
...
法人利益:  ¥4,000,000
法人税等:  約¥1,000,000
個人税負担: 約¥888,000（所得税+住民税）
社保(本人): 約¥900,000
社保(会社): 約¥900,000
合計負担:  約¥3,688,000
手取り:   約¥6,312,000

→ 法人化で約¥43,000の節税 + 社保の充実
```
...
```
【個人事業主】
課税所得: ¥14,350,000（青色65万円控除後）
所得税:   約¥2,888,000（税率33%-¥636,000）
住民税:   約¥1,435,000
事業税:   約¥642,000
国保:     約¥850,000（上限）
国民年金:  約¥200,000
