...
比較例（前職年収700万円・東京・協会けんぽ加入）:
  任意継続: 約70万円/年（標準報酬月額×保険料率10%×12ヶ月・全額自己負担）
  国民健康保険: 約65万円/年

  → 前職の収入が低い（年収400万円以下）ほど任意継続が有利になりやすい
  → 前職年収700万円クラスではほぼ同額〜国保の方が安い場合もある
  → 必ず個別に試算して比較すること
  → 2年後に国保に移行（再計算が必要）
```
...
- [フリーランスエンジニアの消費税申告完全ガイド2026](https://techboostblog.com/blog/2026-03-19-freelance-consumption-tax-guide-2026/)
