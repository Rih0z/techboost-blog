...
description: "Elixir Livebook を使ったインタラクティブなデータ分析、機械学習、Web開発の実践ガイド。Jupyter風のノートブック環境をElixirで実現し、リアルタイムコラボレーションやNxによるML実装まで解説。"
pubDate: "2025-02-05"
tags: ['プログラミング', '開発ツール']
heroImage: '../../assets/thumbnails/elixir-livebook-guide.jpg'
---
## Elixir Livebookとは
