...
description: "Temporalを使った耐障害性の高いワークフロー実装方法を、実践的なコード例とともに詳しく解説します。マイクロサービス、バッチ処理、長時間実行タスクの課題を解決します。補償トランザクションやSagaパターンの実装例も紹介します。補償トランザクションやSaga、シグナル/クエリの実装例も紹介します。"
pubDate: "2025-02-05"
tags: ['DevOps', 'バックエンド', 'プログラミング']
heroImage: '../../assets/thumbnails/temporal-workflow-engine.jpg'
---
