...
description: "Rocは高速で使いやすい関数型プログラミング言語。その独自の設計思想、基本的な文法、Rustやその他の言語との違いを詳しく解説します。純粋関数型のメリットやプラットフォーム概念、実用的なCLIアプリの作成方法まで幅広くカバーしています。CLIアプリやWebサーバーの構築例も紹介します。"
pubDate: "2025-02-05"
tags: ['プログラミング', '開発ツール']
heroImage: '../../assets/thumbnails/roc-language-guide.jpg'
---
